...
+ (UILabel *)FTT_ControlToolUILabelFrame:(CGRect)Frame
                                AndTitle:(NSString *)Title
                             AndFontSize:(int)Fontsize
    ...
    if (IS_Show) {
        [label.layer addSublayer:[TT_ControlTool FTT_ControlToolCALayerFrame:lineFrame AndImageName:nil AndBackgtoundColor:[UIColor getColor:@"#ededed"] BorderColor:nil BorderWidth:0 masksToBounds:NO corerRadius:0]];
    }
    return label;
